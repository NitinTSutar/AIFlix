...
const Header = () => {
    ...
    return (
        <div className="absolute w-screen px-2 md:px-8 py-0 md:py-2 bg-gradient-to-b from-black z-10 flex flex-col md:flex-row justify-between ">
            ...
            {user && (
                <div className="flex justify-between items-center gap-1 md:gap-3">
                   {showGptSeach &&  <select
                    ...
                    <img
                        className="hidden md:inline w-12 h-12 rounded-full"
                        src={
                    ...
                    <button
                        ...
                        className="bg-gray-500/50 text-xs md:text-md text-white py-1 px-4 rounded-md hover:bg-red-600/80 cursor-pointer"
                    >
